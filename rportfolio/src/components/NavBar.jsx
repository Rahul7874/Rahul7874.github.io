  ...
  return (
    <div className="flex justify-between items-center w-full h-20 px-4 text-blue-600 bg-slate-200 fixed nav">
      <div>
        ...
        <h1 className="text-5xl font-signature ml-2"><a className="link-underline link-underline-black" href="https://Rahul7874.github.io:" target="_blank" rel="noreferrer">Rahul</a></h1>
      </div>
